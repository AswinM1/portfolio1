      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {projects.map((project, index) => (
          <motion.a
            ...
            className="border border-neutral-600 p-6 rounded-lg hover:bg-gradient-to-l from-[#309828] to-neutral-800 transition-all duration-500 ease-in-out"
            variants={child}
          >
            ...
            <div className="text-neutral-400 flex flex-wrap gap-3">
              {project.techStack.map((tech, idx) => (
                <span
                  key={idx}
                  className="bg-black text-sm text-neutral-300 py-1 px-2 rounded-xl"
                >
                  {tech}
                </span>
              ))}
